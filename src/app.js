...
myForm.addEventListener("submit", e => {
  ...
  testInputRegex(creditCard, regexValidators["creditCard"], result =>
    !result ? errors.push("Please enter a valid credit card number.") : false
  );
  testInputRegex(cvc, regexValidators["cvc"], result =>
    !result ? errors.push("Please enter a valid CVC.") : false
  );
  testInputRegex(firstName, regexValidators["name"], result =>
    !result ? errors.push("Please enter a valid first name.") : false
  );
  testInputRegex(lastName, regexValidators["name"], result =>
    !result ? errors.push("Please enter a valid last name.") : false
  );
  testInputRegex(postalCode, regexValidators["postalCode"], result =>
    !result ? errors.push("Please enter a valid zip.") : false
  );
  testInputRegex(city, regexValidators["name"], result =>
    !result ? errors.push("Please enter a valid city.") : false
  );
  ...
  if (typeof parseInt(creditCard.value) == "number") {
    if (creditCard.classList.contains("is-invalid"))
